        ...
        @foreach($cart as $key => $item)
            ...
            <li class="flex gap-3 py-4 px-5">
                ...
                <div class="flex-1 min-w-0">
                    <a href="{{ get_falcon_permalink(['slug' => $item['slug'], 'type' => 'product']) }}" class="block text-[13px] font-bold text-heading hover:text-primary leading-snug line-clamp-2">{{ $item['name'] }}</a>

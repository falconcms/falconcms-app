...
#<?php echo e($gridId); ?>-wrap:focus{outline:none}
.lz-cz-dot{transition:width .3s,background .3s,opacity .2s}
.lz-cz-dot:hover{opacity:.7}
</style>

<div class="lazy-card-grid <?php echo e($visCls); ?> <?php echo e($cssCls); ?>"
     <?php if($cssId): ?> id="<?php echo e($cssId); ?>" <?php endif; ?>
     style="<?php echo e($marginStyle); ?>">
    <?php if($layout === 'carousel'): ?>
    <div id="<?php echo e($gridId); ?>-wrap">
        <?php if($showArrows): ?>
        
        <button type="button" aria-label="Previous" id="<?php echo e($gridId); ?>-prev" class="lz-cz-arrow" onclick="lzSlider('<?php echo e($gridId); ?>','prev')"
                style="position:absolute;left:<?php echo e($arrowOffset); ?>px;top:50%;transform:translateY(-50%);z-index:10;width:<?php echo e($arrowSize); ?>px;height:<?php echo e($arrowSize); ?>px;border-radius:50%;background:<?php echo e($arrowBg); ?>;border:1.5px solid rgba(0,0,0,.08);box-shadow:0 2px 10px rgba(0,0,0,.12);display:flex;align-items:center;justify-content:center;cursor:pointer;">
            <svg width="<?php echo e($arrowIconSize); ?>" height="<?php echo e($arrowIconSize); ?>" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($arrowIconColor); ?>" stroke-width="2.5"><polyline points="15 18 9 12 15 6"/></svg>
        </button>
        
        <button type="button" aria-label="Next" id="<?php echo e($gridId); ?>-next" class="lz-cz-arrow" onclick="lzSlider('<?php echo e($gridId); ?>','next')"
                style="position:absolute;right:<?php echo e($arrowOffset); ?>px;top:50%;transform:translateY(-50%);z-index:10;width:<?php echo e($arrowSize); ?>px;height:<?php echo e($arrowSize); ?>px;border-radius:50%;background:<?php echo e($arrowBg); ?>;border:1.5px solid rgba(0,0,0,.08);box-shadow:0 2px 10px rgba(0,0,0,.12);display:flex;align-items:center;justify-content:center;cursor:pointer;">
            <svg width="<?php echo e($arrowIconSize); ?>" height="<?php echo e($arrowIconSize); ?>" viewBox="0 0 24 24" fill="none" stroke="<?php echo e($arrowIconColor); ?>" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
        </button>
        <?php endif; ?>
    <?php endif; ?>
    <div id="<?php echo e($gridId); ?>">
        ...
        ?>
        <?php if(!empty($cardLayout)): ?>
        <div style="break-inside:avoid<?php echo e($alignItems === 'stretch' ? ';display:flex;flex-direction:column' : ''); ?>">
            <?php echo $__env->make('falcon-cms::frontend.builder.render', ['layout' => $cardLayout, 'cardStretch' => $alignItems === 'stretch'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <?php else: ?>
        <article class="lazy-post-card <?php echo e($cardStyleCss); ?> <?php echo e($hoverCss); ?> rounded-lg overflow-hidden bg-white" style="break-inside:avoid">

            <?php if($showImage && $imgSrc): ?>
            <a href="<?php echo e($permalink); ?>" class="block overflow-hidden">
                <div style="position:relative;padding-bottom:<?php echo e($ratioPadding); ?>;overflow:hidden;">
                    <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($post->title); ?>"
                         style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;">
                </div>
            </a>
            <?php endif; ?>

            <div class="<?php echo e($cardStyle === 'boxed' ? '' : 'p-5'); ?>">
                <?php if($showCats && $categories->count()): ?>
                <div class="flex flex-wrap gap-1 mb-2">
                    ...
                    <a href="<?php echo e(url('/category/' . ($cat->slug ?? ''))); ?>"
                ...
                <h3 style="font-size:16px;font-weight:700;line-height:1.35;margin:0 0 8px;">
                    <a href="<?php echo e($permalink); ?>" style="color:inherit;text-decoration:none;"><?php echo e($post->title); ?></a>
                </h3>
                <?php endif; ?>

                <?php if($showExcerpt && $excerpt): ?>
                <p style="font-size:13px;color:#6b7280;line-height:1.6;margin:0 0 10px;"><?php echo e($excerpt); ?></p>
                <?php endif; ?>
    ...
    <?php if($layout === 'carousel'): ?>
    <?php $carouselTotal = count($posts); $slidesPerView = $cols; ?>
    </div>
    <?php if($showDots && $carouselTotal > 1): ?>
    
    <div id="<?php echo e($gridId); ?>-dots" style="display:flex;justify-content:center;align-items:center;gap:<?php echo e($dotGap); ?>px;margin-top:<?php echo e($dotsOffset); ?>px"></div>
    <?php endif; ?>
    <script>
    (function(){
        var perView       = <?php echo e($slidesPerView); ?>;
        var perViewTablet = <?php echo e($colsTablet); ?>;
        var perViewMobile = <?php echo e($colsMobile); ?>;
        var bpMed = <?php echo e($bpMed); ?>;
        var bpSm  = <?php echo e($bpSm); ?>;
        var gap   = <?php echo e($colSpacing); ?>;
        var loop  = <?php echo e($carouselLoop ? 'true' : 'false'); ?>;
        var autoplay      = <?php echo e($carouselAutoplay ? 'true' : 'false'); ?>;
        var autoplaySpeed = <?php echo e($autoplaySpeed); ?>;
        var dotColor  = '<?php echo e($dotColor); ?>', dotActive = '<?php echo e($dotActiveColor); ?>';
        var dotSize   = <?php echo e($dotSize); ?>, dotBorder = <?php echo e($dotBorder); ?>, dotBorderColor = '<?php echo e($dotBorderColor); ?>';
        var id    = '<?php echo e($gridId); ?>';
    ...
    <?php $isPaginated = $paginationType !== 'none' && ($posts instanceof \Illuminate\Pagination\LengthAwarePaginator) && $layout !== 'carousel'; ?>
    <?php if($isPaginated): ?>

        <?php if($paginationType === 'numbered'): ?>
        <?php
        ...
        <nav class="lz-pagination">
            ...
            <a class="lz-pg-prev" href="<?php echo e($posts->previousPageUrl()); ?>">&#8249;</a>
            <?php endif; ?>

            <?php if($pages[0] > 1): ?>
                <a href="<?php echo e($posts->url(1)); ?>">1</a>
                <?php if($pages[0] > 2): ?><span class="lz-pg-dots">…</span><?php endif; ?>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($p === $curPage): ?>
                <span class="lz-pg-active"><?php echo e($p); ?></span>
                <?php else: ?>
                <a href="<?php echo e($posts->url($p)); ?>"><?php echo e($p); ?></a>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <?php if(end($pages) < $lastPage): ?>
                <?php if(end($pages) < $lastPage - 1): ?><span class="lz-pg-dots">…</span><?php endif; ?>
                <a href="<?php echo e($posts->url($lastPage)); ?>"><?php echo e($lastPage); ?></a>
            <?php endif; ?>

            <?php if($posts->hasMorePages()): ?>
            <a class="lz-pg-next" href="<?php echo e($posts->nextPageUrl()); ?>">&#8250;</a>
            <?php endif; ?>
        </nav>
        <?php endif; ?>

        <?php elseif($paginationType === 'load_more'): ?>
        <?php if($posts->hasMorePages()): ?>
        <style>
        ...
        <div id="lmw-<?php echo e($gridId); ?>" class="lz-lm-wrap">
            <button id="lmbtn-<?php echo e($gridId); ?>" data-next="<?php echo e($posts->nextPageUrl()); ?>" class="lz-lm-btn">
        ...
        <script>
        (function(){
            var btn  = document.getElementById('lmbtn-<?php echo e($gridId); ?>');
            var wrap = document.getElementById('lmw-<?php echo e($gridId); ?>');
            var grid = document.getElementById('<?php echo e($gridId); ?>');
            if (!btn || !grid) return;
            async function loadMore() {
                ...
                try {
                    ...
                    var src = doc.getElementById('<?php echo e($gridId); ?>');
                    if (src) Array.from(src.children).forEach(function(c){ grid.appendChild(c.cloneNode(true)); });
                    var nb  = doc.getElementById('lmbtn-<?php echo e($gridId); ?>');
        ...
        <?php elseif($paginationType === 'infinite'): ?>
        <style>
        ...
        <div id="lmw-<?php echo e($gridId); ?>" data-next="<?php echo e($posts->hasMorePages() ? $posts->nextPageUrl() : ''); ?>" style="height:1px;margin-top:24px;"></div>
        <div id="lmloader-<?php echo e($gridId); ?>" class="lz-inf-loader">
            <span class="lz-inf-dot"></span><span class="lz-inf-dot"></span><span class="lz-inf-dot"></span>
        </div>
        <script>
        (function(){
            var sentinel = document.getElementById('lmw-<?php echo e($gridId); ?>');
            var loader   = document.getElementById('lmloader-<?php echo e($gridId); ?>');
            if (!sentinel) return;
            var loading = false;
            async function loadNext() {
                ...
                try {
                    ...
                    var ns = doc.getElementById('lmw-<?php echo e($gridId); ?>');
...
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/frontend/builder/elements/card.blade.php ENDPATH**/ ?>
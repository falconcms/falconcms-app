...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'falcon-cms::components.layouts.admin','data' => ['title' => 'Shop Settings','activeMenu' => 'shop']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Shop Settings','active-menu' => 'shop']); ?>
    <div class="px-2" x-data="{
        tab: '<?php echo e(request('tab', session('active_shop_tab', 'general'))); ?>',
        sellingLocations: '<?php echo e(get_shop_option('shop_selling_locations', 'all')); ?>',
        shippingLocations: '<?php echo e(get_shop_option('shop_shipping_locations', 'all')); ?>',
        manageStock: <?php echo e(get_shop_option('shop_manage_stock', '1') === '1' ? 'true' : 'false'); ?>
    ...
    >
        ...
        <?php echo $__env->make('falcon-cms::admin.shop.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <form action="<?php echo e(route('admin.shop.settings.save')); ?>" method="POST" class="max-w-[800px]">
            <?php echo csrf_field(); ?>
            ...
            <div x-show="tab === 'general'" x-transition>
                ...
                <table class="w-full border-separate border-spacing-y-6 mb-8">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="store_name" value="<?php echo e(get_shop_option('shop_store_name')); ?>" placeholder="<?php echo e(get_cms_option('site_name', 'My Shop')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                ...
                <table class="w-full border-separate border-spacing-y-6">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="address_line_1" value="<?php echo e(get_shop_option('shop_address_line_1')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <input type="text" name="address_line_2" value="<?php echo e(get_shop_option('shop_address_line_2')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <input type="text" name="city" value="<?php echo e(get_shop_option('shop_city')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <select name="country_state" id="country_state" class="wp-input w-[400px]">
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(get_shop_option('shop_country_state') === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="postcode" value="<?php echo e(get_shop_option('shop_postcode')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                        </td>
                    </tr>
                    ...
                    <tr x-show="sellingLocations === 'specific'" x-transition>
                        ...
                        <td>
                            <select name="selling_specific_countries[]" id="selling_specific_countries" multiple class="wp-input w-[400px]">
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $selected = get_shop_option('shop_selling_specific_countries', []); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(in_array($val, (array)$selected) ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr x-show="sellingLocations === 'all_except'" x-transition>
                        ...
                        <td>
                            <select name="selling_except_countries[]" id="selling_except_countries" multiple class="wp-input w-[400px]">
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $selected = get_shop_option('shop_selling_except_countries', []); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(in_array($val, (array)$selected) ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    ...
                    <tr x-show="shippingLocations === 'specific'" x-transition>
                        ...
                        <td>
                            <select name="shipping_specific_countries[]" id="shipping_specific_countries" multiple class="wp-input w-[400px]">
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $selected = get_shop_option('shop_shipping_specific_countries', []); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(in_array($val, (array)$selected) ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="default_customer_location" class="wp-input w-[400px] h-8 py-0">
                                <option value="none" <?php echo e(get_shop_option('shop_default_customer_location') === 'none' ? 'selected' : ''); ?>>No location by default</option>
                                <option value="base" <?php echo e(get_shop_option('shop_default_customer_location') === 'base' ? 'selected' : ''); ?>>Shop country/region</option>
                                <option value="geolocate" <?php echo e(get_shop_option('shop_default_customer_location') === 'geolocate' ? 'selected' : ''); ?>>Geolocate</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="calc_taxes" value="1" <?php echo e(get_shop_option('shop_calc_taxes') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="currency" id="shop_currency" class="wp-input w-[400px]">
                                <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val); ?>" <?php echo e(get_shop_option('shop_currency') === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="currency_pos" class="wp-input w-[200px] h-8 py-0">
                                <option value="left" <?php echo e(get_shop_option('shop_currency_pos', 'left') === 'left' ? 'selected' : ''); ?>>Left</option>
                                <option value="right" <?php echo e(get_shop_option('shop_currency_pos') === 'right' ? 'selected' : ''); ?>>Right</option>
                                <option value="left_space" <?php echo e(get_shop_option('shop_currency_pos') === 'left_space' ? 'selected' : ''); ?>>Left with space</option>
                                <option value="right_space" <?php echo e(get_shop_option('shop_currency_pos') === 'right_space' ? 'selected' : ''); ?>>Right with space</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="thousand_sep" value="<?php echo e(get_shop_option('shop_thousand_sep', ',')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <input type="text" name="decimal_sep" value="<?php echo e(get_shop_option('shop_decimal_sep', '.')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <input type="number" name="num_decimals" value="<?php echo e(get_shop_option('shop_num_decimals', '2')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table class="w-full border-separate border-spacing-y-6">
                        ...
                        <td>
                            <select name="shop_page_id" id="shop_page_id" class="wp-input w-[400px]">
                                ...
                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($page->id); ?>" <?php echo e(get_shop_option('shop_shop_page_id') == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cart_page_id" id="cart_page_id" class="wp-input w-[400px]">
                                <option value="">Select a page...</option>
                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($page->id); ?>" <?php echo e(get_shop_option('shop_cart_page_id') == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="checkout_page_id" id="checkout_page_id" class="wp-input w-[400px]">
                                <option value="">Select a page...</option>
                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($page->id); ?>" <?php echo e(get_shop_option('shop_checkout_page_id') == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="account_page_id" id="account_page_id" class="wp-input w-[400px]">
                                <option value="">Select a page...</option>
                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($page->id); ?>" <?php echo e(get_shop_option('shop_account_page_id') == $page->id ? 'selected' : ''); ?>><?php echo e($page->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="weight_unit" class="wp-input w-[200px] h-8 py-0">
                                <option value="kg" <?php echo e(get_shop_option('shop_weight_unit', 'kg') === 'kg' ? 'selected' : ''); ?>>kg</option>
                                <option value="g" <?php echo e(get_shop_option('shop_weight_unit') === 'g' ? 'selected' : ''); ?>>g</option>
                                <option value="lbs" <?php echo e(get_shop_option('shop_weight_unit') === 'lbs' ? 'selected' : ''); ?>>lbs</option>
                                <option value="oz" <?php echo e(get_shop_option('shop_weight_unit') === 'oz' ? 'selected' : ''); ?>>oz</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select name="dimensions_unit" class="wp-input w-[200px] h-8 py-0">
                                <option value="cm" <?php echo e(get_shop_option('shop_dimensions_unit', 'cm') === 'cm' ? 'selected' : ''); ?>>cm</option>
                                <option value="mm" <?php echo e(get_shop_option('shop_dimensions_unit') === 'mm' ? 'selected' : ''); ?>>mm</option>
                                <option value="in" <?php echo e(get_shop_option('shop_dimensions_unit') === 'in' ? 'selected' : ''); ?>>in</option>
                                <option value="yd" <?php echo e(get_shop_option('shop_dimensions_unit') === 'yd' ? 'selected' : ''); ?>>yd</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="enable_reviews" value="1" <?php echo e(get_shop_option('shop_enable_reviews', '1') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="enable_review_rating" value="1" <?php echo e(get_shop_option('shop_enable_review_rating', '1') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <template x-if="manageStock">
                        <tr x-transition>
                            ...
                            <td>
                                <input type="number" name="hold_stock" value="<?php echo e(get_shop_option('shop_hold_stock', '60')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                            ...
                            <td>
                                <div class="space-y-3">
                                    <label class="flex items-center cursor-pointer">
                                        ...
                                        <input type="checkbox" name="notification_low_stock" value="1" <?php echo e(get_shop_option('shop_notification_low_stock', '1') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                        <span class="text-[14px] text-[#1d2327]">Enable low stock notifications</span>
                                    </label>
                                    <label class="flex items-center cursor-pointer">
                                        <input type="hidden" name="notification_no_stock" value="0">
                                        <input type="checkbox" name="notification_no_stock" value="1" <?php echo e(get_shop_option('shop_notification_no_stock', '1') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="low_stock_threshold" value="<?php echo e(get_shop_option('shop_low_stock_threshold', '2')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <input type="number" name="out_of_stock_threshold" value="<?php echo e(get_shop_option('shop_out_of_stock_threshold', '0')); ?>" class="wp-input w-[100px] h-8 shadow-sm text-center">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" class="w-[200px] text-left align-top pt-2">
                        ...
                        <td>
                            <select name="stock_display_format" class="wp-input w-[400px] h-8 py-0">
                                <option value="always" <?php echo e(get_shop_option('shop_stock_display_format', 'always') === 'always' ? 'selected' : ''); ?>>Always show quantity remaining in stock</option>
                                <option value="low" <?php echo e(get_shop_option('shop_stock_display_format') === 'low' ? 'selected' : ''); ?>>Only show quantity remaining in stock when low</option>
                                <option value="never" <?php echo e(get_shop_option('shop_stock_display_format') === 'never' ? 'selected' : ''); ?>>Never show stock amount</option>
                            </select>
                        </td>
                    </tr>
                </table>
                    ...
                    <div class="border border-[#c3c4c7] rounded p-4 bg-[#f6f7f7]">
                        <div class="flex items-center justify-between mb-4 pb-2 border-b border-[#c3c4c7]">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="payment_cod_enable" value="1" <?php echo e(get_shop_option('shop_payment_cod_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                        ...
                        <table class="w-full border-separate border-spacing-y-4">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="payment_cod_title" value="<?php echo e(get_shop_option('shop_payment_cod_title', 'Cash on Delivery')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <textarea name="payment_cod_desc" class="wp-input w-full h-20 p-2 shadow-sm"><?php echo e(get_shop_option('shop_payment_cod_desc', 'Pay with cash upon delivery.')); ?></textarea>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="border border-[#c3c4c7] rounded p-4 bg-[#f6f7f7]">
                        <div class="flex items-center justify-between mb-4 pb-2 border-b border-[#c3c4c7]">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="payment_bank_enable" value="1" <?php echo e(get_shop_option('shop_payment_bank_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                <span class="text-[14px] font-medium">Enable</span>
                            </label>
                        </div>
                        <table class="w-full border-separate border-spacing-y-4">
                    ...
                    <div class="border border-[#c3c4c7] rounded p-4 bg-[#f6f7f7]">
                        <div class="flex items-center justify-between mb-4 pb-2 border-b border-[#c3c4c7]">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="payment_paypal_enable" value="1" <?php echo e(get_shop_option('shop_payment_paypal_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                <span class="text-[14px] font-medium">Enable</span>
                            </label>
                        </div>
                        <table class="w-full border-separate border-spacing-y-4">
                            <tr>
                                ...
                                <td>
                                    <input type="email" name="payment_paypal_email" value="<?php echo e(get_shop_option('shop_payment_paypal_email')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <input type="checkbox" name="payment_paypal_sandbox" value="1" <?php echo e(get_shop_option('shop_payment_paypal_sandbox') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <div class="border border-[#c3c4c7] rounded p-4 bg-[#f6f7f7]">
                        <div class="flex items-center justify-between mb-4 pb-2 border-b border-[#c3c4c7]">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="payment_stripe_enable" value="1" <?php echo e(get_shop_option('shop_payment_stripe_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                <span class="text-[14px] font-medium">Enable</span>
                            </label>
                        </div>
                        <table class="w-full border-separate border-spacing-y-4">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="payment_stripe_key" value="<?php echo e(get_shop_option('shop_payment_stripe_key')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <input type="password" name="payment_stripe_secret" value="<?php echo e(get_shop_option('shop_payment_stripe_secret')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <input type="password" name="payment_stripe_webhook_secret" value="<?php echo e(get_shop_option('shop_payment_stripe_webhook_secret')); ?>" class="wp-input w-full h-8 shadow-sm" placeholder="whsec_...">
                    ...
                    <div class="border border-[#c3c4c7] rounded p-4 bg-[#f6f7f7]">
                        <div class="flex items-center justify-between mb-4 pb-2 border-b border-[#c3c4c7]">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="payment_sslcommerz_enable" value="1" <?php echo e(get_shop_option('shop_payment_sslcommerz_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                <span class="text-[14px] font-medium">Enable</span>
                            </label>
                        </div>
                        <table class="w-full border-separate border-spacing-y-4">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="payment_sslcommerz_store_id" value="<?php echo e(get_shop_option('shop_payment_sslcommerz_store_id')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <input type="password" name="payment_sslcommerz_store_pass" value="<?php echo e(get_shop_option('shop_payment_sslcommerz_store_pass')); ?>" class="wp-input w-full h-8 shadow-sm">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="w-[200px] text-left align-top pt-2">
                                ...
                                <td>
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <input type="checkbox" name="payment_sslcommerz_sandbox" value="1" <?php echo e(get_shop_option('shop_payment_sslcommerz_sandbox') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
            ...
            <div x-show="tab === 'shipping'" x-transition 
                 x-data="{ 
                    shippingZones: <?php echo e(json_encode(get_shop_option('shop_shipping_zones', []))); ?>
                ...
                <table class="w-full border-separate border-spacing-y-6">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="0.01" name="flat_rate_cost" value="<?php echo e(get_shop_option('shop_flat_rate_cost', '0')); ?>" class="wp-input w-[200px] h-8 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" step="0.01" name="free_shipping_threshold" value="<?php echo e(get_shop_option('shop_free_shipping_threshold', '0')); ?>" class="wp-input w-[200px] h-8 shadow-sm">
                                            ...
                                            <div>
                                                ...
                                                ">
                                                    <select :name="'shipping_zones['+index+'][countries][]'" multiple class="wp-input w-full">
                                                        <?php $__currentLoopData = $allowedCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="local_pickup_enable" value="1" <?php echo e(get_shop_option('shop_local_pickup_enable') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                        ...
                        <td>
                            <div class="space-y-3">
                                <label class="inline-flex items-center cursor-pointer">
                                    ...
                                    <input type="checkbox" name="calc_enable_cart_estimator" value="1" <?php echo e(get_shop_option('shop_calc_enable_cart_estimator') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                ...
                                <label class="inline-flex items-center cursor-pointer">
                                    ...
                                    <input type="checkbox" name="calc_hide_until_address" value="1" <?php echo e(get_shop_option('shop_calc_hide_until_address') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                ...
                                <label class="inline-flex items-center cursor-pointer">
                                    ...
                                    <input type="checkbox" name="calc_hide_paid_when_free" value="1" <?php echo e(get_shop_option('shop_calc_hide_paid_when_free') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="space-y-3">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="shipping_destination" value="shipping" <?php echo e(get_shop_option('shop_shipping_destination', 'shipping') === 'shipping' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                    <span class="text-[14px]">Use the customer's shipping address as the primary target</span>
                                </label>
                                <br>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="shipping_destination" value="billing" <?php echo e(get_shop_option('shop_shipping_destination') === 'billing' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                    <span class="text-[14px]">Set the billing address as the initial delivery choice</span>
                                </label>
                                <br>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="radio" name="shipping_destination" value="force_billing" <?php echo e(get_shop_option('shop_shipping_destination') === 'force_billing' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
            ...
            <div x-show="tab === 'tax'" x-transition
                 x-data="{ 
                    taxRates: <?php echo e(json_encode(get_shop_option('shop_tax_rates', []))); ?>,
                    enableTax: <?php echo e(get_shop_option('shop_calc_taxes', '0') === '1' ? 'true' : 'false'); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="tax_calculation_basis" class="wp-input w-[300px] h-8 py-0">
                                    <option value="shipping" <?php echo e(get_shop_option('shop_tax_calculation_basis') === 'shipping' ? 'selected' : ''); ?>>Customer shipping address</option>
                                    <option value="billing" <?php echo e(get_shop_option('shop_tax_calculation_basis') === 'billing' ? 'selected' : ''); ?>>Customer billing address</option>
                                    <option value="base" <?php echo e(get_shop_option('shop_tax_calculation_basis') === 'base' ? 'selected' : ''); ?>>Shop base address</option>
                                </select>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <select name="tax_price_entry" class="wp-input w-[300px] h-8 py-0">
                                            <option value="exclusive" <?php echo e(get_shop_option('shop_tax_price_entry') === 'exclusive' ? 'selected' : ''); ?>>No, I will enter prices exclusive of tax</option>
                                            <option value="inclusive" <?php echo e(get_shop_option('shop_tax_price_entry') === 'inclusive' ? 'selected' : ''); ?>>Yes, I will enter prices inclusive of tax</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="tax_display_shop" class="wp-input w-[300px] h-8 py-0">
                                            <option value="exclusive" <?php echo e(get_shop_option('shop_tax_display_shop', 'exclusive') === 'exclusive' ? 'selected' : ''); ?>>Excluding tax</option>
                                            <option value="inclusive" <?php echo e(get_shop_option('shop_tax_display_shop') === 'inclusive' ? 'selected' : ''); ?>>Including tax</option>
                                        </select>
                                    </div>
                                </div>
            ...
            <div x-show="tab === 'coupons'" x-transition
                 x-data="{ 
                    coupons: <?php echo e(json_encode(get_shop_option('shop_coupons', []))); ?>
                ...
                <table class="w-full border-separate border-spacing-y-6">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="space-y-3">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="enable_coupons" value="1" <?php echo e((int)get_shop_option('shop_enable_coupons', '1') == 1 ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                    <span class="text-[14px]">Enable the use of coupon codes</span>
                                </label>
                                <br>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="multi_coupon_policy" value="1" <?php echo e((int)get_shop_option('shop_coupon_stacking_policy', '1') == 1 ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                ...
                <table class="w-full border-separate border-spacing-y-6">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="space-y-3">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="enable_guest_checkout" value="1" <?php echo e(get_shop_option('shop_enable_guest_checkout', '1') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                                    <span class="text-[14px] text-[#1d2327]">Allow customers to place orders without an account</span>
                                </label>
                                <br>
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="force_login_checkout" value="1" <?php echo e(get_shop_option('shop_force_login_checkout', '0') === '1' ? 'checked' : ''); ?> class="w-4 h-4 mr-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="email_from_name" value="<?php echo e(get_shop_option('shop_email_from_name', config('app.name', 'Falcon Shop'))); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="email" name="email_from_address" value="<?php echo e(get_shop_option('shop_email_from_address', 'store@' . request()->getHost())); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="email" name="email_admin_recipient" value="<?php echo e(get_shop_option('shop_email_admin_recipient', auth()->user()->email ?? '')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="email_header_image" value="<?php echo e(get_shop_option('shop_email_header_image')); ?>" class="wp-input w-[400px] h-8 shadow-sm" placeholder="https://example.com/logo.png">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="email_footer_text" value="<?php echo e(get_shop_option('shop_email_footer_text', 'Thank you for shopping with us!')); ?>" class="wp-input w-[400px] h-8 shadow-sm">
                        </td>
                    </tr>
                </table>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/admin/shop/settings.blade.php ENDPATH**/ ?>
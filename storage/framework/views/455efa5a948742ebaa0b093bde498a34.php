...
?>
<?php if($status === 'published' && $showByCondition): ?>
    <?php $ctnAnimType = $s['anim_type'] ?? ''; ?>
    <<?php echo e($htmlTag); ?> id="<?php echo e($s['menuAnchor'] ?? ''); ?>" class="lazy-container <?php echo e($cid); ?> <?php echo e($hoverClass); ?> <?php echo e($s['cssClass'] ?? ''); ?> <?php echo e($visibilityClasses); ?> <?php echo e(!empty($s['sticky']) ? 'lazy-sticky-col' : ''); ?><?php echo e($ctnAnimType ? ' lz-anim lz-anim-' . $ctnAnimType : ''); ?><?php echo e($ctnBgLazyUrl ? ' lz-lazy-bg' : ''); ?>" style="<?php echo e(implode('; ', $containerStyles)); ?>"<?php if($ctnAnimType): ?> data-anim-duration="<?php echo e($s['anim_duration'] ?? 600); ?>" data-anim-delay="<?php echo e($s['anim_delay'] ?? 0); ?>" data-anim-easing="<?php echo e($s['anim_easing'] ?? 'ease'); ?>"<?php endif; ?> <?php if($ctnBgLazyUrl): ?> data-bg="<?php echo e($ctnBgLazyUrl); ?>"<?php endif; ?>>
        <?php if($link): ?>
            <a href="<?php echo e($link); ?>" target="<?php echo e($linkTarget); ?>" style="text-decoration: none; color: inherit; display: flex; flex-direction: column; flex-grow: 1; width: 100%;">
        <?php endif; ?>
        <div class="lazy-container-inner <?php echo e($innerClass); ?> flex flex-wrap" style="<?php echo e(implode('; ', $innerStyles)); ?>">
            <?php if(!empty($container['columns'])): ?>
                <?php $__currentLoopData = $container['columns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('falcon-cms::frontend.builder.column', ['column' => $column, 'container' => $container], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/frontend/builder/container.blade.php ENDPATH**/ ?>
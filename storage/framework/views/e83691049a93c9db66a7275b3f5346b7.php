<style>
    @media (max-width: <?php echo e(get_cms_option('theme_small_screen_breakpoint', '800')); ?>px) { 
    ...
    @media (min-width: <?php echo e((int)get_cms_option('theme_small_screen_breakpoint', '800') + 1); ?>px) and (max-width: <?php echo e(get_cms_option('theme_medium_screen_breakpoint', '1100')); ?>px) { .falcon-hide-tablet { display: none !important; } }
    @media (min-width: <?php echo e((int)get_cms_option('theme_medium_screen_breakpoint', '1100') + 1); ?>px) { .falcon-hide-desktop { display: none !important; } }
...
<?php echo $colCss ? '<style>' . $colCss . '</style>' : ''; ?>


<?php if(!empty($s['sticky'])): ?>
<?php if (! $__env->hasRenderedOnce('lazy-sticky-observer-js')): $__env->markAsRenderedOnce('lazy-sticky-observer-js'); ?>
<script>
(function(){
...
?>
<?php if($colShowByCondition): ?>
<<?php echo e($htmlTag); ?> class="lazy-column <?php echo e($colCid); ?> <?php echo e($hoverClass); ?> <?php echo e($visibilityClasses); ?> <?php echo e($s['cssClass'] ?? ''); ?> <?php echo e(!empty($s['sticky']) ? 'lazy-sticky-col' : ''); ?><?php echo e($colAnimType ? ' lz-anim lz-anim-' . $colAnimType : ''); ?>"
    <?php if(!empty($s['cssId'])): ?> id="<?php echo e($s['cssId']); ?>" <?php endif; ?>
    style="<?php echo e(implode('; ', $outerStyles)); ?>"<?php if($colAnimType): ?> data-anim-duration="<?php echo e($s['anim_duration'] ?? 600); ?>" data-anim-delay="<?php echo e($s['anim_delay'] ?? 0); ?>" data-anim-easing="<?php echo e($s['anim_easing'] ?? 'ease'); ?>"<?php endif; ?>>
    
    <?php if($link): ?>
        <a href="<?php echo e($link); ?>" target="<?php echo e($s['linkTarget'] ?? '_self'); ?>" style="text-decoration: none; color: inherit; display: flex !important; flex-direction: column !important; flex-grow: 1 !important; height: 100% !important; width: 100%;">
    <?php endif; ?>
    ...
    <?php endif; ?>
    <div class="lazy-column-inner<?php echo e($colBgLazyUrl ? ' lz-lazy-bg' : ''); ?>" style="<?php echo e(implode('; ', $innerStyles)); ?>"<?php if($colBgLazyUrl): ?> data-bg="<?php echo e($colBgLazyUrl); ?>"<?php endif; ?>>
        <?php if(!empty($column['elements'])): ?>
            <?php $__customBuilderDefs = apply_falcon_filters('falcon_builder_elements', []); ?>
            <?php $__currentLoopData = $column['elements']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($el['type'] === 'row'): ?>
                    <?php if($contentLayout === 'row'): ?>
                        <div style="flex-basis: 100%; width: 100%; height: 0; overflow: hidden;"></div>
                    <?php endif; ?>
                    <?php echo $__env->make('falcon-cms::frontend.builder.container', ['container' => $el], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php if($contentLayout === 'row'): ?>
                        <div style="flex-basis: 100%; width: 100%; height: 0; overflow: hidden;"></div>
                    <?php endif; ?>
                <?php else: ?>
                    ...
                    <?php if($__elView && $__elShow): ?>
                        ...
                        ?>
                        <?php if($__elAnimType): ?>
                            <div class="lz-anim lz-anim-<?php echo e($__elAnimType); ?>" style="width:100%" data-anim-duration="<?php echo e($el['settings']['anim_duration'] ?? 600); ?>" data-anim-delay="<?php echo e($el['settings']['anim_delay'] ?? 0); ?>" data-anim-easing="<?php echo e($el['settings']['anim_easing'] ?? 'ease'); ?>">
                                <?php echo $__env->make($__elView, ['el' => $el], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        <?php else: ?>
                            <?php echo $__env->make($__elView, ['el' => $el], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endif; ?>
                    <?php elseif($__customDef && $__elShow): ?>
                        <?php
                        ...
                        ?>
                        <?php if($__elAnimType): ?>
                            <div class="lz-anim lz-anim-<?php echo e($__elAnimType); ?>" style="width:100%"
                                 data-anim-duration="<?php echo e($el['settings']['anim_duration'] ?? 600); ?>"
                                 data-anim-delay="<?php echo e($el['settings']['anim_delay'] ?? 0); ?>"
                                 data-anim-easing="<?php echo e($el['settings']['anim_easing'] ?? 'ease'); ?>">
                        <?php endif; ?>
                        
                        <div class="falcon-builder-element falcon-custom-block w-full<?php echo e($__ceVis ? ' '.$__ceVis : ''); ?><?php echo e($__ceCssClass ? ' '.$__ceCssClass : ''); ?>"
                             <?php if($__ceCssId): ?> id="<?php echo e($__ceCssId); ?>" <?php endif; ?>>
                            <?php if($__tpl): ?>
                                <?php echo $__env->make($__tpl, ['el' => $el, 's' => $el['settings'] ?? []], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php else: ?>
                                <?php echo $__env->make('falcon-cms::frontend.builder.elements.custom', ['el' => $el, 'customDef' => $__customDef], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endif; ?>
                        </div>
                        <?php if($__elAnimType): ?>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/frontend/builder/column.blade.php ENDPATH**/ ?>
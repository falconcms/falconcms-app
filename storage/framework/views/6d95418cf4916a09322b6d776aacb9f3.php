...
<?php if($useLink): ?>
<style>
    #<?php echo e($linkId); ?> { color: <?php echo e($linkColor); ?> !important; text-decoration: none; display: block; transition: color 0.3s ease; }
    #<?php echo e($linkId); ?>:hover { color: <?php echo e($linkHoverColor); ?> !important; }
</style>
<?php endif; ?>
<?php if($titleHoverColor): ?>
<style>
    <?php if(empty($s['useGradient'])): ?>
    #<?php echo e($titleElemId); ?> { color: <?php echo e($s['titleColor'] ?: '#222'); ?>; transition: color 0.3s ease; }
    #<?php echo e($titleElemId); ?>:hover { color: <?php echo e($titleHoverColor); ?> !important; }
    <?php else: ?>
    #<?php echo e($titleElemId); ?>:hover { color: <?php echo e($titleHoverColor); ?> !important; -webkit-text-fill-color: <?php echo e($titleHoverColor); ?> !important; background-image: none !important; }
    <?php endif; ?>
</style>
<?php endif; ?>
<?php if($respCss): ?>
<style><?php echo $respCss; ?></style>
<?php endif; ?>

<div class="element-title-wrapper <?php echo e($titleRespId); ?> <?php echo e($s['cssClass'] ?? ''); ?> <?php echo e($visibilityClasses); ?>"
     <?php if(!empty($s['cssId'])): ?> id="<?php echo e($s['cssId']); ?>" <?php endif; ?>
     style="<?php echo e(implode('; ', $wrapperStyles)); ?>">

    <?php if($useLink): ?>
        <a href="<?php echo e($linkUrl); ?>" id="<?php echo e($linkId); ?>" target="<?php echo e($s['linkTarget'] ?? '_self'); ?>">
    <?php endif; ?>

    <<?php echo e($htmlTag); ?> class="main-title"<?php if($titleElemId): ?> id="<?php echo e($titleElemId); ?>"<?php endif; ?> style="<?php echo e(implode('; ', $titleStyles)); ?>">
    ...
    <?php if($separator !== 'none'): ?>
        <div class="title-divider" style="<?php echo e(collect($dividerStyles)->map(fn($v, $k) => "$k: $v")->implode('; ')); ?>"></div>
    <?php endif; ?>
</div>
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/frontend/builder/elements/title.blade.php ENDPATH**/ ?>
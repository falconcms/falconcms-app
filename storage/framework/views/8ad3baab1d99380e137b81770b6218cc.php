<?php $wlPid = $product->id ?? ($productId ?? 0); $wlActive = lazy_in_wishlist($wlPid); ?>
<button type="button"
        class="lazy-wishlist-btn<?php echo e($wlActive ? ' is-active' : ''); ?>"
        data-product-id="<?php echo e($wlPid); ?>"
        title="<?php echo e($wlActive ? 'In your wishlist' : 'Add to wishlist'); ?>"
        aria-label="Add to wishlist">
    <i data-lucide="heart"></i>
</button>

<?php if (! $__env->hasRenderedOnce('aff05cac-32de-47c1-8a81-a5f326e3396e')): $__env->markAsRenderedOnce('aff05cac-32de-47c1-8a81-a5f326e3396e'); ?>
<style>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/themes/falcon-theme/partials/wishlist-button.blade.php ENDPATH**/ ?>
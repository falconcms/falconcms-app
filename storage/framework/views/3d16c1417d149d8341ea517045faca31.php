...
<div class="bg-white py-12 min-h-screen font-sans">
    <div class="container-custom">
        ...
        <?php if(count($cart) > 0): ?>
        <?php if(get_shop_option('shop_enable_coupons', '1') === '1'): ?>
        ...
        <form action="<?php echo e(route('shop.place-order')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex flex-col md:flex-row gap-12 mb-12">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <?php $guestCheckout = get_shop_option('shop_enable_guest_checkout', '1') === '1'; ?>
                    ...
                    <div class="mb-4 border border-[#ddd] rounded-sm p-4 bg-[#fafafa]">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="password" name="account_password" autocomplete="new-password" class="w-full border border-[#ddd] rounded-sm px-3 py-2 text-[14px] focus:border-primary outline-none <?php echo e($errors->has('account_password') ? 'border-red-400' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        <label class="flex items-center gap-2 cursor-pointer mb-2 select-none">
                            <input type="checkbox" id="toggle-create-account" <?php echo e(old('create_account') ? 'checked' : ''); ?>
                        ...
                        <input type="hidden" id="create-account-flag" name="create_account" value="<?php echo e(old('create_account', '')); ?>">
                        <div id="create-account-fields" class="<?php echo e(old('create_account') ? '' : 'hidden'); ?> border border-[#ddd] rounded-sm p-4 bg-[#fafafa] mt-2">
                            <div class="space-y-1.5">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="w-full md:w-1/2">
                    <div class="mb-6">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" id="ship-different" name="ship_to_different_address" value="1" <?php echo e(old('ship_to_different_address') ? 'checked' : ''); ?> onchange="document.getElementById('shipping-form').classList.toggle('hidden')" class="w-4 h-4 border-[#ddd] rounded-sm text-primary focus:ring-0">
                            <span class="text-[20px] font-bold text-heading uppercase tracking-tight">Ship to a different address?</span>
                        </label>
                    </div>

                    <div id="shipping-form" class="<?php echo e(old('ship_to_different_address') ? '' : 'hidden'); ?> mb-8 border-t border-[#eee] pt-6">
                    ...
                    <div class="space-y-2 mt-6">
                        ...
                        <textarea name="order_comments" rows="3" placeholder="Notes about your order, e.g. special notes for delivery." class="w-full border border-[#ddd] rounded-sm px-3 py-2 text-[14px] focus:border-primary outline-none resize-none"><?php echo e(old('order_comments')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12">
                ...
                <div class="border border-[#eee] bg-white">
                    <table class="w-full border-collapse text-[14px]">
                        ...
                        <tbody id="order-review-body">
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-[#eee]">
                                    <td class="p-4 text-body">
                                        <?php echo apply_falcon_filters('lazy_checkout_item_name',
                                        ...
                                        <?php echo falcon_render_item_custom_fields($item, 'checkout'); ?>

                                        <?php do_falcon_action('lazy_checkout_item_meta', $item); ?>
                                    </td>
                                    <td class="p-4 text-right font-medium text-heading">
                                        <?php echo e(falcon_price_format(($item['sale_price'] ?: $item['price']) * $item['quantity'])); ?>
                            ...
                            <tr class="border-b border-[#eee]">
                                ...
                                <td class="text-right p-4 font-bold text-heading" id="checkout-subtotal"><?php echo e(falcon_price_format(get_falcon_cart_subtotal())); ?></td>
                            </tr>

                            <tr class="border-b border-[#eee]">
                                <th class="text-left p-4 font-bold text-heading">Shipping</th>
                                <td class="text-right p-4 text-body" id="checkout-shipping">
                                    <?php $shipDetails = get_falcon_cart_shipping_details(session('falcon_shipping_country')); ?>
                                    <?php echo e($shipDetails['label']); ?>: <span class="font-bold text-heading"><?php echo e($shipDetails['cost'] > 0 ? falcon_price_format($shipDetails['cost']) : 'Free'); ?></span>
                                </td>
                            </tr>

                            <?php if(get_cms_option('shop_enable_tax') === '1'): ?>
                            <tr class="border-b border-[#eee]">
                                <th class="text-left p-4 font-bold text-heading">Estimated Tax</th>
                                <td class="text-right p-4 font-bold text-heading" id="checkout-tax"><?php echo e(falcon_price_format(get_falcon_cart_tax())); ?></td>
                            </tr>
                            <?php endif; ?>
                            ...
                            ?>
                            <?php $__currentLoopData = $appliedCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php 
                                ...
                                <tr class="coupon-row bg-emerald-50/10 border-b border-[#eee]">
                                    <th class="text-left p-4 font-bold text-emerald-700 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            Coupon: <?php echo e($coupon['code']); ?>

                                        </div>
                                    </th>
                                    <td class="text-right p-4 font-bold text-emerald-700">-<?php echo e(falcon_price_format($discount)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <tr class="bg-[#fcfcfc]">
                                <th class="text-left p-4 font-bold text-heading">Total</th>
                                <td class="text-right p-4 text-[18px] font-bold text-primary" id="checkout-total"><?php echo e(falcon_price_format(get_falcon_cart_total())); ?></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <?php $gateways = falcon_enabled_payment_gateways(); $firstGw = array_key_first($gateways); ?>
                    <div class="p-8 border-t border-[#eee]">
                        <div class="max-w-4xl">
                            ...
                            <?php else: ?>
                            <div class="bg-[#f7f6f7] p-6 mb-8 relative rounded-sm" x-data="{ method: '<?php echo e($firstGw); ?>' }">
                                ...
                                <div class="space-y-3">
                                    <?php $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="payment_method" value="<?php echo e($gw['id']); ?>" x-model="method" class="w-4 h-4 text-primary focus:ring-0">
                                            <span class="text-[14px] font-bold text-heading"><?php echo e($gw['title']); ?></span>
                                        </label>
                                        <div x-show="method === '<?php echo e($gw['id']); ?>'" x-cloak class="bg-white/50 border border-black/5 p-4 text-[14px] text-body rounded-sm whitespace-pre-line"><?php echo e($gw['desc']); ?></div>
                                        <?php if($gw['id'] === 'stripe'): ?>
                            ...
                            <button type="submit" <?php if(empty($gateways)): ?> disabled <?php endif; ?> class="bg-primary text-white px-10 py-4 rounded-sm font-bold text-[16px] hover:bg-primary-hover transition-all shadow-lg uppercase disabled:opacity-50 disabled:cursor-not-allowed">
                                Place order
                            </button>
        ...
        <div class="bg-white p-20 text-center border border-[#eee] rounded-sm">
            ...
            <a href="<?php echo e(get_lazy_shop_url()); ?>" class="inline-block bg-primary text-white px-8 py-3 rounded-sm font-bold hover:bg-primary-hover transition-colors uppercase">Return to shop</a>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php if(isset($gateways) && isset($gateways['stripe'])): ?>
...
function applyCoupon() {
    ...
    fetch('<?php echo e(route('shop.cart.coupon')); ?>', {
        method: 'POST',
        headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    const checkoutForm = document.querySelector('form[action="<?php echo e(route('shop.place-order')); ?>"]');
    ...
    function refreshCheckoutShipping() {
        ...
        fetch('<?php echo e(route('shop.cart.shipping.update')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
    ...
    <?php if(isset($gateways) && isset($gateways['stripe'])): ?>
    const stripePubKey = <?php echo json_encode(get_shop_option('shop_payment_stripe_key', ''), 512) ?>;
        ...
        checkoutForm.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.stripe_payment && data.client_secret && stripe && stripeCard) {
                    stripe.confirmCardPayment(data.client_secret, {
                        ...
                        if (result.error) {
                            ...
                            Swal.fire({ title: 'Payment failed', text: result.error.message, icon: 'error', confirmButtonColor: '<?php echo e(get_cms_option('theme_primary_color', '#0091ea')); ?>' });
                ...
                if (data.success && data.redirect) {
                    ...
                    Swal.fire({ title: 'Error', text: data.message, icon: 'error', confirmButtonColor: '<?php echo e(get_cms_option('theme_primary_color', '#0091ea')); ?>' });
                    submitBtn.innerText = originalText;
                    submitBtn.disabled = false;
                }
            })
            .catch(error => {
                ...
                Swal.fire({ title: 'Error!', text: 'Something went wrong while processing your order. Please try again.', icon: 'error', confirmButtonColor: '<?php echo e(get_cms_option('theme_primary_color', '#0091ea')); ?>' });
                submitBtn.innerText = originalText;
                submitBtn.disabled = false;
            });
        });
    ...
    (function () {
        ...
        var TEXT  = ['billing_first_name','billing_last_name','billing_email','billing_phone',
                     ...
                     'order_comments'].concat(<?php echo json_encode($extraPersistFields, 15, 512) ?>);
...
<?php echo $__env->make('falcon-cms::themes.falcon-theme.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\lazy-panda\vendor\tareqcodex\lazy-cms-rebuild\src/../resources/views/themes/falcon-theme/ecommerce/checkout.blade.php ENDPATH**/ ?>
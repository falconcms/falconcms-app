...
@endif
@if(!empty($fsFonts))
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?{{ collect($fsFonts)->map(fn($f) => 'family=' . str_replace(' ', '+', $f) . ':ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,700')->implode('&') }}&display=swap">
@endif
@if(!empty($fsIcons))
